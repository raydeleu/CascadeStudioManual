...
---
._Model of a nut modelled with Antimony (https://github.com/mkeeter/antimony)
image::https://github.com/raydeleu/CascadeStudioManual/blob/main/images/antimony-nut.png[antimony,700]
---
