...
[#gizmo] 
image::https://github.com/raydeleu/CascadeStudioManual/blob/main/images/gizmo.png[rotation,600]
---
...
Todo: explain the steps to import a STEP, IGS or STL file. 
