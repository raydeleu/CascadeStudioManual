...
planview = Translate([-l4,0,0],planview,false)

// build the first block of 5 floors
let block1 = Translate([0,0,hgap],RotatedExtrude(planview, hblock, a4 ))
let entrance = RotatedExtrude(planview, hgap, a4*(hgap/h1) )
