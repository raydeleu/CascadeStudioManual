...
---
_.Different sizes of gears generated with a tailor-made function in CascadeStudio_
...
---
.Exercise part to demonstrate modelling techniques
...
---
.The design intent becomes clear when changes to design parameters are considered
...
---
.Different vacuum heads all generated from same code with different values for the design parameters
...
---
.Model of Gherkin Tower with floors and out panels generated from a parametric model
