...
https://github.com/raydeleu/CascadeStudioManual/blob/main/images/gherkin_shape.png

==== Create derivative products
Apart from design variations, discussed above, parametric design also makes derivative designs much easier. This could be a stretched version of an airplane or car, but also tailored versions of a hook such as shown in the image below (ref: http://sergepayen.fr/en/parametric-u-hook/)

https://github.com/raydeleu/CascadeStudioManual/blob/main/images/uHook-01b-gamme-sergePayen.jpg
